...
var app = (function () {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 30, 8, 738);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:6) <Button selected={true}         >",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(28:4) {#each $filterKeys as key}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 25, 2, 600);
    			attr_dev(span, "class", "filter-box__clear svelte-1206ctn");
    			add_location(span, file$1, 37, 2, 889);
    			attr_dev(section, "class", "filter-box svelte-1206ctn");
    			add_location(section, file$1, 24, 0, 569);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
